...
The authors note  this is stable and implicit abd go on to explain a complex method of solving this recursion relation, we can see that this is of the form $$A w^{j+1} = B w^{j}$$ and use the Crank Nicolson method with the double-sweep algorithm.
...
Below is the familiar double-sweep method from previous R Lab exercises which will use in the Crank Nicolson method. First, recall that the recursive formulas are
$$
...
```
<center>![Figure 2](Figures/Figure 1.jpg)</center>
...
```
<center>![Figure 2](Figures/Figure 2.jpg)</center>
...
```
<center>![Figure 3](Figures/Figure 3.jpg)</center>
...
<center>![Figure 4](Figures/Figure 4.jpg)</center>
...
```
<center>![Figure 5](Figures/Figure 5.jpg)</center>
...
<center>![Figure 6](Figures/Figure 6.jpg)</center>
